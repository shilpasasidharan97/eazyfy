...
urlpatterns = [
    ...
    path("sell_laptops/", views.sell_laptops, name="sell_laptops"),
    path("sell_camera/", views.sell_camera, name="sell_camera"),
    path("sell_buds/", views.sell_buds, name="sell_buds"),
