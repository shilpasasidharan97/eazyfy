# Generated by Django 4.1.2 on 2023-01-03 07:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("question_type", models.CharField(choices=[("image", "Image"), ("Objective", "Objective"), ("text", "Text")], max_length=15)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("question", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="official.questions")),
            ],
