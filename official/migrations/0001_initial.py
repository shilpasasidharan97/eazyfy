...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("question_type", models.CharField(choices=[("image", "Image"), ("Objective", "Objective"), ("MCQ", "MCQ")], max_length=15)),
                ("question", models.CharField(blank=True, help_text="Eg: Are you able to make and receive calls?", max_length=500, null=True)),
                ("subtext", models.CharField(blank=True, help_text="Eg: Check your device for cellular network connectivity issues.", max_length=500, null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("identifier", models.CharField(blank=True, help_text="Eg: Able to Make and Receive Calls", max_length=500, null=True)),
                ("question", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="official.question")),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("option", models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="official.questionoption")),
                ("question", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="official.question")),
                ("user_question_answer", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="official.userrequest")),
            ],
        ),
        migrations.CreateModel(
            name="PickUpBoy",
